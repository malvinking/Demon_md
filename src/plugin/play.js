      ...
      if (selectedMedia) {
        try {
          ...
          if (type === 'audio' && fileSizeInMB <= 300) {
            content = { audio: finalMediaBuffer, mimetype: 'audio/mpeg', caption: 'Downloaded by ᴅᴇᴍᴏɴ_ᴍᴅ' };
          } else if (type === 'video' && fileSizeInMB <= 300) {
            content = { video: finalMediaBuffer, mimetype: 'video/mp4', caption: 'Downloaded by ᴅᴇᴍᴏɴ_ᴍᴅ' };
